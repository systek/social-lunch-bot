...
raskt - da kan nemlig en annen heldig vinner få plassen din!`,
      ...
      getAcceptNotificationText: (): string => `Så hyggelig at du kan være med! 😃 Vi sender lenke samme morgen!`,
      getRejectNotificationText: (): string => `Det går fint, vi trekker noen andre denne gang!`,
    },
  },
}
